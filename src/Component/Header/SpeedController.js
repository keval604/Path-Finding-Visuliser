...
const SpeedController=(props)=>{
    ...
    return (
        <div class="slidecontainer row">
            ...
            <div class="col-auto align-items-center"><input type="range" class="form-range slider" min="1" max="1000" value={props.speed} id="myRange" ref={selectRef} onChange={changeSpeed}/></div>
        </div>
    );
}
